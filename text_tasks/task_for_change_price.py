...
def task_837():
    ...
    item1, item2, _, _ = generate_context()
    while True:
        ...
        if result * 1000 % 1000 == 0:
          ...
          answer = result
          break
    task = f'{capitalize_word(item1)} дороже {choosing_declension_form(item2)} на {percent}%. На сколько процентов {item2} дешевле {choosing_declension_form(item1)}?'
    return task, answer
...
def task_850():
    ...
    product, _, _, _ = generate_context()
    while True:
        ...
        if result != 0 and result * 1000 % 1000 == 0:
          ...
          break
    task = f'Цена на {choosing_declension_form(product, "accs")} сначала увеличилась на {percent1}% процентов, а потом уменьшилась на {percent2}%. На сколько процентов и в какую сторону изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_873():
    ...
    while True:
        ...
        if result < 0 and abs(str(result).find('.') - len(str(result))) - 1 < 4:
            ...
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} сначала два раза увеличилась на {percent1}%, а потом уменьшилась на {percent2}%. Как и на сколько процентов изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_876():
    ...
    while True:
        ...
        if result < 0 and abs(str(result).find('.') - len(str(result))) - 1 < 4:
            ...
            answer = f'цена не изменилась'
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} выросла на {percent1}%, потом упала на {percent2}%, потом опять упала на {percent3}%. Как и на сколько процентов изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_4503():
    ...
    _, product, _, _ = generate_context()
    while True:
        percent = random.randint(2, 30)
        ...
        if result * 1000 % 1000 == 0 and price % 10 != 1:
            answer = int(result)
            break
    task = f'Дисконтная карточка в магазине «Marks&Spencer» даёт мне скидку {percent}%. Цена {choosing_declension_form(product)} с учётом скидки составила {price} рубл{"я" if price % 10 in [2, 3, 4] else "ей"}. Сколько сто{"ит" if find_number_object(product) == 1 else "ят"} {product} без скидки?'
    return task, answer
    ...
    while True:
        ...
        if contr % 100 == 0 and profit % 10 in [0, 5, 6, 7, 8, 9]:
          ...
          if result * 10000 % 10000 == 0:
              ...
              answer = result
              break
    task = f'Вкладчик положил в банк {contr} {choosing_declension_form(value)}. Проценты по вкладу составили {profit} {choosing_declension_form(value)}. Какова доходность вклада?'
    return task, answer
...
def task_4713():
    ...
    product1, product2, _, _ = generate_context()
    while True:
        ...
        if result * 100000 % 100000 == 0:
            ...
            answer = result
            break
    task = f'{capitalize_word(product1)} дороже {choosing_declension_form(product2)} на {percent}%. На сколько процентов {product2} дешевле {choosing_declension_form(product1)}?'
    return task, answer
...
def task_4751():
    ...
    while True:
        ...
        if result * 100000 % 10000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} была снижена на {percent}%. На сколько процентов надо теперь её повысить, чтобы получить первоначальную цену?'
    return task, answer
    ...
    while True:
        ...
        if price % 10 == 0:
          ...
          if result * 10000 % 10000 == 0:
              answer = int(result)
              break
    task = f'{capitalize_word(product)} стоит {price} рублей. В связи с поступлением новой коллекции {product} продают со скидкой {percent}%. Сколько стоит {product} с учётом скидки?'
    return task, answer
...
def task_4673():
    ...
    while True:
        ...
        if result * 1000 % 100000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} понизилась на {int(percent) if percent*10%10==0 else percent}% и составила {int(cost) if cost*10%10==0 else cost} рубля. Найдите первоначальную цену {choosing_declension_form(product)}?'
    return task, answer
    ...
    while True:
        ...
        if price1 < price2 and price1 * 10 % 10 == 0 and price2 * 10 % 10 != 1:
          ...
          if result * 1000 % 1000 == 0:
              answer = int(result)
              break
    task = f'Цена {choosing_declension_form(product)} повысилась с {price1} рублей до {price2} рублей. На сколько процентов была повышена цена {choosing_declension_form(product)}?'
    return task, answer
...
def task_8548():
    ...
    while True:
        ...
        if result * 100 % 10000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} была повышена на {percent}% и составила {price} рубля. Сколько рублей стоил{"o" if find_genus_object(product)== 3 else "a" if find_genus_object(product)== 2 else ""} {product} до повышения цены?'
    return task, answer
...
def task_4727():
    ...
    while True:
        ...
        if result * 1000 % 1000 == 0:
          ...
          answer = result
          break
    task = f'Цена на {choosing_declension_form(product, "accs")} два раза увеличилась на {percent}%. На сколько процентов увеличилась цена по сравнению с первоначальной?'
    return task, answer
...
def task_4717():
    ...
    while True:
        ...
        if result * 10000 % 10000 == 0:
            ...
            answer = abs(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} сначала снизилась на {percent1}%, потом снизилась ещё на {percent2}%, а потом увеличилась на {percent3}%. На сколько процентов изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_9213():
    ...
    while True:
        ...
        if result * 100 % 10000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} повысилась на {percent}% и составила {price} рублей. Найдите первоначальную цену {choosing_declension_form(product)}.'
    return task, answer
...
def task_9198():
    ...
    while True:
        ...
        if result * 100 % 1000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} повысилась на {percent}% и стала равна {price} рубля. Сколько стоил{"и" if find_number_object(product)==2 else "" if find_genus_object(product)==1 else "a" if find_genus_object(product)==2 else "о"} {product} до повышения цены?'
    return task, answer
...
def task_9460():
    ...
    while True:
        ...
        if result < 0 and abs(str(result).find('.') - len(str(result))) - 1 < 3:
            ...
            answer = f'цена не изменилась'
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} два раза упала на {percent1}%, а потом два раза выросла на {percent2}%. Как и на сколько процентов изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_9461():
    ...
    while True:
        ...
        if result < 0 and abs(str(result).find('.') - len(str(result))) - 1 < 3:
            ...
            answer = f'цена не изменилась'
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} сначала выросла на {percent1}%, потом упала на {percent2}%, потом выросла на {percent3}%, а потом упала на {percent4}%. Как и на сколько процентов изменилась цена {choosing_declension_form(product)} по сравнению с первоначальной?'
    return task, answer
...
def task_9463():
    ...
    while True:
        ...
        if result * 1000 % 1000 == 0:
          ...
          answer = result
          break
    task = f'Цена на {choosing_declension_form(product, "accs")} была повышена на {percent}%. На сколько процентов надо теперь её снизить, чтобы получить первоначальную цену?'
    return task, answer
...
def task_11011():
    ...
    while True:
        ...
        if result < 0 and abs(str(result).find('.') - len(str(result))) - 1 < 3:
            ...
            answer = f'цена не изменилась'
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} увеличилась на {percent1}%, потом уменьшилась на {percent2}%, потом увеличилась на {percent3}%, далее уменьшилась на {percent4}%, и наконец увеличилась на {percent5}%. На сколько процентов и в какую сторону изменилась цена по сравнению с первоначальной?'
    return task, answer
    ...
    while True:
        ...
        if price % 10 == 0:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'Цена на {choosing_declension_form(product, "accs")} увеличилась на {percent1}%, потом ещё на {percent2}%, а потом упала на {percent3}%. Сколько стоит теперь {product}, если первоначально {"он" if find_genus_object(product)==1 else "она" if find_genus_object(product)==2 else "оно"} стоил{"" if find_genus_object(product)==1 else "а" if find_genus_object(product)==2 else "о"} {price} рублей?'
    return task, answer
    ...
    while True:
        ...
        if price % 10 != 1:
          ...
          if result % 10 == 0:
              answer = int(result)
              break
    task = f'Цена на {choosing_declension_form(product, "accs")} понизилась на {percent}% и составила {price} рубл{"я" if price%10 in [2, 3, 4] else "ей"}. Найдите первоначальную цену {choosing_declension_form(product)}.'
    return task, answer
    ...
    while True:
        ...
        if price % 10 == 0:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'{capitalize_word(product)} сто{"ит" if find_number_object(product)==1 else "ят"} {price} рублей. В магазине проводят распродажу со скидкой {percent}%. Сколько сто{"ит" if find_number_object(product)==1 else "ят"} {product} на распродаже?'
    return task, answer
    ...
    while True:
        ...
        if price % 10 != 1:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'Цена на {choosing_declension_form(product, "accs")} в течение месяца упала сначала на {percent1}%, а затем на {percent2}% и составила {price} рубл{"я" if price%10 in [2, 3, 4] else "ей"}. Найдите исходную цену {choosing_declension_form(product)}.'
    return task, answer
    ...
    while True:
        ...
        if price % 10 != 1:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'Цена {choosing_declension_form(product)} сначала поднялась на {percent1}%, потом уменьшилась на {percent2}%, далее увеличилась на {percent3}% и стала равна {price} рубл{"я" if price%10 in [2, 3, 4] else "ей"}. Найдите первоначальную цену {choosing_declension_form(product)}.'
    return task, answer
...
def task_11051():
    ...
    while True:
        ...
        if result * 1000 % 1000 == 0:
            ...
            answer = result
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} была снижена дважды − сначала на {percent1}%, а потом ещё на {percent2}%. Каков общий процент снижения цены?'
    return task, answer
    ...
    while True:
        ...
        if price % 10 != 1:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'Цена {choosing_declension_form(product)} поднялась сначала на {percent1}%, потом ещё на {percent2}% и стала равна {price} рубл{"я" if price%10 in [2, 3, 4] else "ей"}. Найдите первоначальную цену {choosing_declension_form(product)}.'
    return task, answer
    ...
    while True:
        ...
        if price % 10 != 1:
          ...
          if result * 1000 % 1000 == 0:
              ...
              answer = result
              break
    task = f'Цена на {choosing_declension_form(product, "accs")} в течение месяца упала сначала на {percent1}%, а потом увеличилась на {percent2}% и составила {price} рубл{"я" if price%10 in [2, 3, 4] else "ей"}. Найдите первоначальную цену {choosing_declension_form(product)}.'
    return task, answer
    ...
    while True:
        ...
        if decline ** 0.5 * 1000 % 1000 == 0:
          ...
          if result * 1000 % 1000 == 0:
            ...
            answer = result
            break
    task = f'Первоначально цена на {choosing_declension_form(product, "accs")} была повышена на {percent1}%, затем 2 раза понижалась на одинаковое число процентов. В результате конечная цена оказалась на {percent2}% меньше первоначальной. На сколько процентов производилось двукратное снижение цены?'
    return task, answer
...
def task_35687():
    ...
    while True:
        ...
        if result * 10000 % 10000 == 0:
            ...
            break
    task = f'Магазин увеличил цену {choosing_declension_form(product)} в {multipl} раз. Однако по результатам проверки антимонопольная служба предписала вернуть прежнюю цену. На сколько процентов придётся снизить цену? Ответ подать в процентах, округлить до десятых'
    return task, answer
...
def task_35690():
    ...
    _, _, _, product = generate_context()
    while True:
        percent  = random.randint(2, 30)
        ...
        if result * 10000 % 10000 == 0:
            ...
            break
    task = f'В начале мая цена на {choosing_declension_form(product, "accs")} повысилась на {percent}%, а в начале июня понизилась на {percent}%. На сколько процентов цена {choosing_declension_form(product)} в июне после понижения стала ниже, чем цена {choosing_declension_form(product)} в мае до повышения? Ответ подать в процентах, округлить до целого'
    return task, answer
...
def task_35702():
    ...
    while True:
        ...
        if result * 1000 % 10000 == 0:
            answer = int(result)
            break
    task = f'Цена на {choosing_declension_form(product, "accs")} была повышена на {percent}% и составила {price} рублей. Сколько рублей стоил{"" if find_genus_object(product)==1 else "а" if find_genus_object(product)==2 else "о"} {product} до повышения цены?'
    return task, answer
    ...
    while True:
        ...
        if price1 > price2 and price1 % 10 != 1 and price2 % 10 != 1:
          ...
          if result * 10000 % 10000 == 0:
              ...
              answer = result
              break
    task = f'{capitalize_word(product)} стоил{"и" if find_number_object(product) == 2 else "" if find_genus_object(product)==1 else "а" if find_genus_object(product)==2 else "о"} {price1} рубл{"я" if price1%10 in [2, 3, 4] else "ей"}. После снижения цены {"они" if find_number_object(product)==2 else "он" if find_genus_object(product)==1 else "она" if find_genus_object(product)==2 else "оно"} стал{"и" if find_number_object(product) == 2 else "" if find_genus_object(product)==1 else "а" if find_genus_object(product)==2 else "о"} стоить {price2} рубл{"я" if price2%10 in [2, 3, 4] else "ей"}. На сколько процентов была снижена цена на {choosing_declension_form(product, "accs")}?'
    return task, answer