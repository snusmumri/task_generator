...
def determine_max_min_values(prototype):
    ...
    if len(max_min) > 1:
        ...
        result = 0
        note_solution = r'не удалось найти, так как на отрезке есть только одно значение; в ответе пишем 0'
        text = r'Наибольшее и наименьшее значение функции: \( y= '
    else:
        result = 0
        note_solution = r'не удалось найти, так как на отрезке нет значений; в ответе пишем 0'
